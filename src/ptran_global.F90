...
!...........................................................
  integer, parameter :: &
    ...
    nxkmx	= 1,	& ! kinetic aqueous homogeneous reactions
    nexmx	= 6,	& ! exchange cations
    nsitxmx	= 4,	& ! exchange sites
    nsitmx	= 6,	& ! surface complex sites
    nscxmx	= 4,	& ! surface complexes
    nrgmx	= 100,  & ! max no. of regions (COMP+BCON+SOUR, MNIR)
    nrgbcmx	= 100,	& ! max no. of boundary regions
...
!...........................................................
  ...
  integer, parameter :: dbaselen = 256, strlen = 128, wordlen = 32, &
                        namlen = 20, cardlen = 4
...
!...........................................................
  ...
  integer               :: iloop
  integer               :: jph,iph,joh,jo2,jo2aq,jpe,jco2,jhco3, &
                           jfe3,jfe2,ife3,ife2,jh2o,jo2g,jco2g,jh2g
...
!...........................................................
  ...
  real*8  :: timesrc(nstbmx,nsrcmx),tempsrc(nstbmx,nsrcmx), &
             qsrc(nstbmx,nsrcmx),ctotsrc(ncmx,nsrcmx)
...
! LBM
!...........................................................
  integer :: ntimes,icheck,iwrite,ishift,iread,iseed,in,inn,ibndtp, &
             nrevx,nrevy,fnrevy,iprimary_min,i_ini_tra
  real*8 :: nbsat
  real*8 :: bsat,rhol,rhor,uin,tau0,ff,epsss=1.d-6
  logical :: new,flowsteady,initial_slt,advection
