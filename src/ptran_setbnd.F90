...
!               cloctot(l),rho1
 ...
 1000 format (/,'        --> compute source composition:',i3, &
      '  temp = ',1pg10.3)
 1005 format (/,'        --> compute source composition:',i3, &
      '  temp = ',1pg10.3,'  iter =',i4)
 1010 format (2x,'--> boundary condition:  type =',i2, &
      '  temp = ',1pg10.3,'  iter =',i4)   
 1011 format (2x,'--> boundary condition:  type',i2, &
      '  temp = ',1pg10.3,'  iter =',i4,' matrx')   
 1012 format (2x,'--> boundary condition:  type',i2, &
