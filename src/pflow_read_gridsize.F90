...
contains
  ...
  subroutine pflow_read_gridsize(inputfile, nx, ny, nz, npx, npy, npz, &
  nphase, ndof, idcdm, ierr)
  ...
  integer, intent(out) :: nx, ny, nz, npx, npy, npz, nphase, ndof
  integer, intent(out) :: idcdm, ierr
